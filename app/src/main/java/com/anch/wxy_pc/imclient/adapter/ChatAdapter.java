        ...
        if (conversationBeans != null) {
            ...
            switch (getItemViewType(position)) {
                case ViewType.COME_MSG:
                    ...
                    holder.userHeadIv.setImageBitmap(BitmapUtils.getRoundedCornerBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.default_left_head), 130));
                    break;
                case ViewType.TO_MSG:
                    holder.chatUserNameTv.setText(conversationBean.getSession_id());
                    holder.userHeadIv.setImageBitmap(BitmapUtils.getRoundedCornerBitmap(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.default_right_head), 130));
                    break;
            }
        }
        return convertView;
